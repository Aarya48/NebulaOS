        ...
        <div className="relative z-10 w-full h-full overflow-y-auto overflow-x-hidden flex flex-col items-center px-8 xl:px-24 scrollbar-hide">
          ...
          <div className="w-full pb-48 flex flex-col items-center justify-start shrink-0">
            ...
            <div className="flex flex-col md:flex-row gap-8 w-full justify-center">
              {[
                { name: "Anurag Yadav", handle: "CfRadar", color: "cyan" as const, role: "Frontend Developer", linkedin: "https://www.linkedin.com/in/anurag-yadav-142774338/" },
                { name: "Aarya Tiwari", handle: "Aarya48", color: "fuchsia" as const, role: "Backend Developer", linkedin: "https://www.linkedin.com/in/aarya-tiwari1" }
              ].map((contributor, i) => (
                <div 
                  key={i} 
                  className="group relative flex items-center p-6 md:p-8 w-full md:w-1/3 bg-[#05010A]/80 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all duration-500 rounded-3xl overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.5)] hover:-translate-y-1"
                >
