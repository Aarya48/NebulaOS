...
const {
  createFolder,
  createFile,
  getFiles,getFolderContent,rename,deleteItem,moveItem,searchFiles,changeFavorite,getFavorites,getRecentFiles,openFile,getTrashFiles,restoreFile,permanentDelete,updateContent
